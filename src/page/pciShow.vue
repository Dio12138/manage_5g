		...
		methods: {
			...
			showMap1(){
				...
				for (var i = 0; i <tempArr.length-1; i++) {
					var midPci=(this.pci[i]+this.pci[i+1])/2;
					var polyline = new BMap.Polyline([
							tempArr[i],
							tempArr[i+1],
						],
						{strokeColor:this.getColor(midPci), strokeWeight:6, strokeOpacity:0.5}
					);
			...
			getColor(mid){
				var colorVal=[21,22,23];
				var myColor=["#f90000","#006f00","#060798"];
